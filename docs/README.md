...
- [功能-卡片内容复制与排序.md](./功能-卡片内容复制与排序.md)：单卡复制、多卡快速操作、同色分组和 Loom 工作台中的卡片组预览
- [功能-卡片标记.md](./功能-卡片标记.md)：标记的使用方式、显示规则和存储方式
- [功能-查看和编辑卡片属性.md](./功能-查看和编辑卡片属性.md)：单卡片和多卡片属性管理、批量尺寸调整和一键排列
- [技术实现细节.md](./技术实现细节.md)：当前代码结构、主要数据流、性能服务和生命周期约束

## 专题文档

- [功能-按标记顺序复制内容.md](./功能-按标记顺序复制内容.md)：标记排序输出的单独说明
- [功能-Canvas卡片尺寸调整.md](./功能-Canvas卡片尺寸调整.md)：拆分、拼合、属性管理和一键排列的尺寸位置规则
